 ...
 */
export function createPackageConfig(config: PackageViteConfig): UserConfig {
  const {
    packageName,
...
/**
 * Base configuration for all Permanence packages
 */
export const baseConfig = defineConfig({
  // Common settings that apply to all packages
  define: {
